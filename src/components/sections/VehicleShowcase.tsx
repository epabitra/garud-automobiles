        ...
        <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {vehicleCategories.map((v, i) => (
            <Reveal key={v.id} delay={i * 0.08}>
              <Link
                to="/vehicles"
                className="group block h-full overflow-hidden rounded-2xl border border-line bg-surface shadow-soft transition-all duration-300 hover:-translate-y-1 hover:shadow-lift"
              >
